...
from ..login import _verify_otp_and_get_token, _generate_otp_and_send, _is_session_token_exist, _get_profile
...
def verify_token(token:str):
    ...
    return _is_session_token_exist(token, session_type=SESSION_TYPE)
